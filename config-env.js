...
PASSWORD: process.env.PASSWORD || "Sadaruwan123",
GITHUB_USERNAME: process.env.GITHUB_USERNAME || "Mkomkad",
GITHUB_AUTH_TOKEN: process.env.GITHUB_AUTH_TOKEN || "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"
};
